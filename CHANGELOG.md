...
- **Multi-annotator human baseline** replacing the single-annotator pilot: 8 naive
  annotators (6 completed all 200) + 1 expert, collected via the hostable
  ...
  - Engaged annotators (excluding one near-chance, low-agreement outlier) average
    **73.2% ± 7.4%**; expert **95%**; inter-annotator agreement Cohen's
